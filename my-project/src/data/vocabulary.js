export const ALL_VOCAB = [
  ...
  { jp: 'くるま', th: 'รถยนต์', en: 'Car / Vehicle', romaji: 'kuruma', lesson: 2, type: 'ยานพาหนะ' },
  { jp: 'つくえ', th: 'โต๊ะเรียน', en: 'Desk', romaji: 'tsukue', lesson: 2, type: 'ของใช้' },
  { jp: 'いす', th: 'เก้าอี้', en: 'Chair', romaji: 'isu', lesson: 2, type: 'ของใช้' },
  { jp: 'チョコレート', th: 'ช็อกโกแลต', en: 'Chocolate', romaji: 'chokoreeto', lesson: 2, type: 'อาหาร' },
  { jp: 'コーヒー', th: 'กาแฟ', en: 'Coffee', romaji: 'koohii', lesson: 2, type: 'อาหาร' },
  ...
  { jp: 'じどうはんばいき', th: 'เครื่องขายของอัตโนมัติ', en: 'Vending machine', romaji: 'jidouhanbaiki', lesson: 3, type: 'ของใช้' },
  ...
  { jp: 'ワイン', th: 'ไวน์', en: 'Wine', romaji: 'wain', lesson: 3, type: 'อาหาร' },
  ...
  { jp: 'ひとりで', th: 'คนเดียว / โดยลำพัง', en: 'Alone / By oneself', romaji: 'hitori de', lesson: 5, type: 'สำนวน' },
  ...
  { jp: 'イラン', th: 'อิหร่าน', en: 'Iran', romaji: 'Iran', lesson: 1, type: 'ประเทศ' },
  { jp: 'エジプト', th: 'อียิปต์', en: 'Egypt', romaji: 'Ejiputo', lesson: 1, type: 'ประเทศ' },
  { jp: 'オーストラリア', th: 'ออสเตรเลีย', en: 'Australia', romaji: 'Oosutoraria', lesson: 1, type: 'ประเทศ' },
  { jp: 'カナダ', th: 'แคนาดา', en: 'Canada', romaji: 'Kanada', lesson: 1, type: 'ประเทศ' },
  { jp: 'サウジアラビア', th: 'ซาอุดีอาระเบีย', en: 'Saudi Arabia', romaji: 'Saujiarabia', lesson: 1, type: 'ประเทศ' },
  { jp: 'シンガポール', th: 'สิงคโปร์', en: 'Singapore', romaji: 'Shingapooru', lesson: 1, type: 'ประเทศ' },
  { jp: 'スペイン', th: 'สเปน', en: 'Spain', romaji: 'Supein', lesson: 1, type: 'ประเทศ' },
  { jp: 'フィリピン', th: 'ฟิลิปปินส์', en: 'Philippines', romaji: 'Firipin', lesson: 1, type: 'ประเทศ' },
  { jp: 'ベトナム', th: 'เวียดนาม', en: 'Vietnam', romaji: 'Betonamu', lesson: 1, type: 'ประเทศ' },
  { jp: 'マレーシア', th: 'มาเลเซีย', en: 'Malaysia', romaji: 'Mareeshia', lesson: 1, type: 'ประเทศ' },
  { jp: 'ロシア', th: 'รัสเซีย', en: 'Russia', romaji: 'Roshia', lesson: 1, type: 'ประเทศ' },
  ...
  { jp: 'イタリア語', th: 'ภาษาอิตาเลียน', en: 'Italian language', romaji: 'Itariago', lesson: 2, type: 'ภาษา' },
  { jp: 'ペルシア語', th: 'ภาษาเปอร์เซีย', en: 'Persian language', romaji: 'Perushiago', lesson: 2, type: 'ภาษา' },
  { jp: 'ヒンディー語', th: 'ภาษาฮินดี', en: 'Hindi language', romaji: 'Hindigo', lesson: 2, type: 'ภาษา' },
  { jp: 'インドネシア語', th: 'ภาษาอินโดนีเซีย', en: 'Indonesian language', romaji: 'Indoneshiago', lesson: 2, type: 'ภาษา' },
  { jp: 'アラビア語', th: 'ภาษาอาหรับ', en: 'Arabic language', romaji: 'Arabiago', lesson: 2, type: 'ภาษา' },
  { jp: 'フランス語', th: 'ภาษาฝรั่งเศส', en: 'French language', romaji: 'Furansugo', lesson: 2, type: 'ภาษา' },
  { jp: '韓国語', th: 'ภาษาเกาหลี', en: 'Korean language', romaji: 'Kankokugo', lesson: 2, type: 'ภาษา' },
  { jp: 'スペイン語', th: 'ภาษาสเปน', en: 'Spanish language', romaji: 'Supeingo', lesson: 2, type: 'ภาษา' },
  { jp: 'タイ語', th: 'ภาษาไทย', en: 'Thai language', romaji: 'Taigo', lesson: 2, type: 'ภาษา' },
  { jp: '中国語', th: 'ภาษาจีน', en: 'Chinese language', romaji: 'Chuugokugo', lesson: 2, type: 'ภาษา' },
  { jp: 'ドイツ語', th: 'ภาษาเยอรมัน', en: 'German language', romaji: 'Doitsugo', lesson: 2, type: 'ภาษา' },
  { jp: 'フィリピノ語', th: 'ภาษาฟิลิปปินส์', en: 'Filipino language', romaji: 'Firipinog', lesson: 2, type: 'ภาษา' },
  { jp: 'ポルトガル語', th: 'ภาษาโปรตุเกส', en: 'Portuguese language', romaji: 'Porutogarugo', lesson: 2, type: 'ภาษา' },
  { jp: 'ベトナム語', th: 'ภาษาเวียดนาม', en: 'Vietnamese language', romaji: 'Betonamugo', lesson: 2, type: 'ภาษา' },
  { jp: 'マレーシア語', th: 'ภาษามาเลย์', en: 'Malay language', romaji: 'Mareeshiago', lesson: 2, type: 'ภาษา' },
  { jp: 'ロシア語', th: 'ภาษารัสเซีย', en: 'Russian language', romaji: 'Roshiago', lesson: 2, type: 'ภาษา' },
